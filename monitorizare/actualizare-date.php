...
$sql = "UPDATE temperaturi SET atelier = $temperatura_atelier, parter = $temperatura_parter, etaj = $temperatura_etaj, foisor = $temperatura_foisor, exterior = $temperatura_exterior, meteo = $temperatura_meteo, uparter = $umiditate_parter, uetaj = $umiditate_etaj WHERE id_t = 1";
$result = $conn->query($sql);
